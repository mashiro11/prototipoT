...
int main(int argc, char** argv)
{
    ...
    bola.AddTermo("chuva", "img/termofeliz.png", "img/Posts/Termos Felizes/Chuva 1/Chuva_Twitter_11.png", 0, 255, 0, 255);
    bola.AddTermo("engarrafamento", "img/termotriste.png", "img/Posts/Termos Tristes/Engarrafamento 1/Engarrafamento_Twitter_11.png", 0, 255, 0, 100);
